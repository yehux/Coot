...
CodeMirror.defineMode("verilog", function(config, parserConfig) {
  ...
  var keywords = words(
    ...
    "table tagged list this throughout time timeprecision timeunit tran tranif0 tranif1 tri tri0 tri1 triand trior " +
  ...
  */
  ...
  var blockKeywords = words(
    ...
    "primitive program property specify sequence table list"
  );
  ...
  return {
    ...
    token: function(stream, state) {
      ...
      if (curPunc == ctx.type) {
        ...
        } else if (curKeyword == "list" && ctx && ctx.type == "statement") {
          // Same thing for list
        } else {
